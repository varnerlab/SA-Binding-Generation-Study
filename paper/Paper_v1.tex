...
\begin{figure}[t]
  ...
  \caption{\textbf{The hard mask isolates the gap decomposition: recovery depends on
  both retrieval sharpness and residual background mass.}
  ...
  $\beta^{*}(\vr)$) sit below this envelope by the empirical $\Delta_{\mathrm{attn}}$,
  significant at weak conditioning (0.111, SE 0.027, at $f_{\mathrm{eff}} = 0.5$) and
  ...
  $\beta$. Hard curation (green triangle) reaches complete transfer at low $\beta$ on
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lccc@{}}
    ...
    Hard curation (subset basis)                 & 3.2 & $1.00 \pm 0.00$ & 0.33 \\
    \bottomrule
  \end{tabular}
\end{table}
