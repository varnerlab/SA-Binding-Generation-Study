...
are equal and converges to $K_{\mathrm{des}}$ as $\rho \to \infty$. Empirically, $\beta^{*}$
increases monotonically from 4.3 ($\rho = 1$, $K_{\mathrm{eff}} = 99$) to 10.1 ($\rho = 1000$,
$K_{\mathrm{eff}} = 32.1$) in the Kunitz domain, consistent with the system becoming harder to
order as fewer effective patterns contribute competing attractors.
