...
We assessed whether preserved pharmacophores translate to predicted binding competence by performing ColabFold AlphaFold2-multimer predictions for representative SA-generated sequences paired with the Cav2.2 pore-domain target (Table~\ref{tab:docking-validation}). The rerun used only multimer predictions and includes 10 SA strong-conditioned, 10 SA full-conditioned, and 5 natural $\omega$-conotoxin controls.
Complex-level means were low across all groups: SA strong-conditioned sequences had mean pTM $0.221\pm0.007$, iPTM $0.105\pm0.008$, and interface-pLDDT $37.2\pm5.4$; SA full-conditioned sequences had mean pTM $0.219\pm0.008$, iPTM $0.104\pm0.007$, and interface-pLDDT $38.2\pm4.0$; and controls had mean pTM $0.228\pm0.004$, iPTM $0.108\pm0.007$, and interface-pLDDT $40.7\pm3.5$.
No pairwise group comparisons reached significance at $\alpha=0.05$ (exact permutation tests for all pairwise contrasts; all $p>0.05$).
Because interface-based complex confidence remains modest and sample sizes are still limited, this should be read as a conservative screening result rather than a definitive binding benchmark; stronger claims will require larger control sets and downstream experimental validation. Framed that way, the docking results support pharmacophore-level plausibility for generated candidates under multimer prediction assumptions, but do not yet establish high-confidence binding superiority.
