...
($< 0.3\%$) at all $\rho$ values, consistent with Proposition~\ref{prop:score}: the multiplicity
weights tilted the energy landscape as intended. The observed P1~K/R fraction increased
monotonically from 0.41 ($\rho=1$) to 0.63 ($\rho=500$), exceeding the natural
