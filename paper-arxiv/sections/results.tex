...
plausibility (Fig.~\ref{fig:plddt-tmscore-scatter}). We scored 50 Kunitz sequences from each of
...
70, and mean TM-score $0.60\pm0.19$.
Independent AlphaFold2-ptm predictions reproduced the Kunitz picture, with TM-scores of
0.83--0.85 at pLDDT 93--95 (Table~\ref{tab:structure-model-comparison})
~\cite{jumperHighlyAccurate2021,mirdita2022colabfold}. The 26-residue $\omega$-conotoxins scored
lower against their reference structure (1OMG, chain~A), but so did the stored natural sequences
scored alongside them. Under AlphaFold2-ptm, TM-scores were $0.35\pm0.12$ for stored
$\omega$-conotoxins, $0.39\pm0.12$ for full-family generation, and $0.47\pm0.02$ for
designated-subset generation, at pLDDT 68--79; ESMFold gave $0.43\pm0.07$, $0.46\pm0.03$, and
$0.46\pm0.03$ for the same three groups (Table~\ref{tab:structure-model-comparison}). Generated
peptides therefore matched or exceeded stored ones under both predictors, and the low absolute
values track TM-score normalization at 26 residues rather than a loss of fold similarity under
conditioning.
Sequence scoring with ESM2 also placed SA
