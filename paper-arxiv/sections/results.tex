...
its sequences, short of the 0.996 target and essentially tied with SA at 0.838. Both sit at the
ceiling their designation allows: only 19 of the 23 designated conotoxin sequences carry Tyr13,
so even perfect conditioning on that set would yield the marker in $19/23 = 0.83$ of the
output. Matching the marker more closely did not, however, make for better sequences overall. In the matched Kunitz
...
$\omega$-conotoxins and retained 26 positions after gap filtering. Of those, 23 accessions
appeared on the curated list and formed the designated subset. The remaining 51 formed the
background, which we treated as unlabeled rather than as nonbinders.
...
Multiplicity weighting transferred the marker in this family as well, and did so better than in
any Pfam family. Sweeping $\rho$ to 500 raised decoded Tyr13 to $0.838 \pm 0.035$ (Supporting
Information), against 0.587 for Kunitz at the same ratio. Because only 19 of the 23 designated
accessions carry Tyr13, perfect conditioning would itself yield about 0.83, so the weighting
reached the ceiling its designation allows. That is what the geometry predicts:
$\omega$-conotoxin has the cleanest PCA separation in the panel
