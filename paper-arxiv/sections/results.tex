...
per-position correlations were $r=0.745$ for designated-subset generation and $r=0.997$ for
full-family generation. The five highest-pLDDT designated-subset
sequences retained all six highly conserved cysteine positions while introducing
6--11 substitutions at variable sites (Fig.~\ref{fig:conotoxin-sequence-analysis}).
...
natural sequences scored alongside them. Under AlphaFold2-ptm, TM-scores were $0.35\pm0.12$ for stored
...
peptides therefore had mean TM-scores equal to or higher than stored ones under both predictors.
