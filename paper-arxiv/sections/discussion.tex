...
simple logit bias, and their equilibrium target is a known Gaussian mixture. The finite-step ULA
implementation retains discretization and mixing error, which we assess against exact samples.
