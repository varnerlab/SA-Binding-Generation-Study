...
\end{align}
This is Eq.~\eqref{eq:rho-inverse} in the main text. Equal similarity gives
...
Table~\ref{tab:per-family-rho}). This residual includes finite sampling, mixing,
...
standard deviations. Table~\ref{tab:beta-sweep} reports phenotype fraction and
