...
unit-norm model, and we use it as the reference in the exact-equilibrium benchmark. We retain ULA for the reported
...
concentration. It equals $K$ when all $r_k$ are equal and converges to $K_{\mathrm{des}}$
as $\rho \to \infty$.
...
on pairwise cosine similarities. It is not the classical Fisher discriminant criterion,
