...
\beta[\vX\,\softmax(\beta\,\vX^{\!\top}\vxi) - \vxi]$ is
...
description of the final step. Let $C$ be the generating mixture component,
let $q_{\mathrm{des}} =
\Pr(\text{decoded marker positive}\mid C\in\mathcal{D})$, and let
$q_{\mathrm{bg}} =
