...
characterize its finite-step behavior. ULA is not required to sample this target. Equation~\eqref{eq:gmm-target}
...
The standard SA framework exhibits an entropy crossover at an operating inverse temperature
