...
ULA chains used step size $\alpha=0.01$ and ran for $T=5{,}000$ steps, each starting near a
stored pattern with patterns assigned cyclically across the memory and with independent local
RNGs generating the initial perturbations and Langevin noise. Samples were collected after
...
an MMseqs2 MSA, and no relaxation, on a Google Colab T4 GPU. Sequence
