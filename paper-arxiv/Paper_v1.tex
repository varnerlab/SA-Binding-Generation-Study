...
\begin{table}[p]
  ...
  The two predictors agree on the ordering within each family. For the 26-residue
  $\omega$-conotoxins, TM-scores are low for the stored natural sequences as well as
  the generated ones, which reflects TM-score normalization at short chain length
  rather than a fold difference introduced by conditioning. These are model-derived
  quantities and do not establish experimental folding or binding.}
