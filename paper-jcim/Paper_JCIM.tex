...
\begin{table}[p]
  ...
  residue (or a K/R substitution at basic positions). Designated-subset generation
  retains the Tyr13 signal and cysteine scaffold and enriches several reported
  positions. These frequencies do not test mutation effects in the generated backgrounds.}
