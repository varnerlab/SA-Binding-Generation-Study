...
% -----------------------------------------------------------------------
% Fig 1: Designated-subset scaling
% -----------------------------------------------------------------------
\begin{figure}[p]
  \centering
...
% -----------------------------------------------------------------------
% Table 5: ω-Conotoxin marker inheritance
% -----------------------------------------------------------------------
\begin{table}[p]
  \centering
...
\begin{table}[p]
  ...
  \caption{\textbf{Low-confidence AlphaFold2-multimer predictions for generated
  and control $\omega$-conotoxins.}
  Complex-level scores for sequences modeled with the Cav2.2 pore domain via
  ColabFold in multimer mode. The uniformly low absolute values do not establish
  binding geometry.}
