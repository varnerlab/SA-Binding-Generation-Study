...
\end{aligned}
\]
These are group-specific latent-to-sequence transfer rates. Each includes
finite-temperature spread around a component as well as reconstruction and decoding.
